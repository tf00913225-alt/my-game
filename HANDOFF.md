## 2026-09-18 — 秘寶碎片背包黑圖／詳情穿圖修復（IMPLEMENTED / QA PENDING）
...
- Requirement batch: `release/requirement-batches/2026-09-18-relic-fragment-inventory-image-fit.json`。狀態待 PR Repository checks 與手機 QA 完成後更新。
