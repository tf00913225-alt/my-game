...
assert.ok(keyIndex>=0 && start>=0 && end>keyIndex,"V173.45 lifecycle block must live in js/00-main.js");
...
console.log("✓ V173.45 same-session resume and background save regression passed");
