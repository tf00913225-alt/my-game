...
assert.match(qol,/css\/53-v173\.51-qa\.css\?v=173\.64/);
assert.match(qol,/js\/54-v173\.51-battle-qa\.js\?v=173\.64/);
assert.match(qol,/js\/55-v173\.51-inventory-qa\.js\?v=173\.64/);
assert.match(qol,/js\/56-v173\.51-shop-qa\.js\?v=173\.64/);
assert.match(qol,/js\/57-v173\.51-quest-qa\.js\?v=173\.64/);
assert.match(equipment,/js\/53-v173\.50-inventory-qol\.js\?v=173\.64/);
