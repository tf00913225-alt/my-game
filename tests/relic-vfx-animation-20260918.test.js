...
const expected=[
    ["relic_qiankun_flask","relic_qiankun_flask.webp",920,7,"allyAll"],
    ["relic_sun_orb","relic_sun_orb.webp",840,7,"enemyAll"],
    ["relic_xuanwu_seal","relic_xuanwu_seal.webp",980,8,"allyAll"],
    ["relic_soul_bell","relic_soul_bell.webp",960,8,"enemyAll"],
    ["relic_tiangang_banner","relic_tiangang_banner.webp",980,9,"enemyAll"],
    ["relic_nine_dragon_fire","relic_nine_dragon_fire.webp",900,8,"enemyAll"],
    ["relic_cold_spring_jade","relic_cold_spring_jade.webp",900,7,"singleAlly"],
    ["relic_qinglan_feather","relic_qinglan_feather.webp",840,6,"allyAll"],
    ["relic_rock_mountain_seal","relic_rock_mountain_seal.webp",960,7,"allyAll"],
    ["relic_returning_wheel","relic_returning_wheel.webp",980,7,"singleAlly"],
    ["relic_origin_talisman","relic_origin_talisman.webp",940,7,"allyAll"],
    ["relic_broken_army_scroll","relic_broken_army_scroll.webp",820,8,"singleEnemy"],
    ["relic_red_sky_war_mark","relic_red_sky_war_mark.webp",840,7,"allyAll"],
    ["relic_ice_mirror_heart","relic_ice_mirror_heart.webp",900,6,"enemyAll"],
    ["relic_wind_chasing_talisman","relic_wind_chasing_talisman.webp",780,6,"allyAll"],
    ["relic_mountain_river_cauldron","relic_mountain_river_cauldron.webp",960,7,"allyAll"],
    ["relic_burning_star_mark","relic_burning_star_mark.webp",840,7,"enemyAll"],
    ["relic_spirit_spring_bottle","relic_spirit_spring_bottle.webp",880,6,"allyAll"],
    ["relic_demon_suppressing_seal","relic_demon_suppressing_seal.webp",940,6,"allyAll"],
    ["relic_all_returning_array","relic_all_returning_array.webp",980,8,"allyAll"]
];
...
assert.match(relic,/presentationLeadGapMs:120/,"relic VFX must fit inside the formal 1150ms post-action beat");
