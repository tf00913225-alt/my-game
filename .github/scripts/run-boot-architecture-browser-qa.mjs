...
try{
    ...
    await waitFor(client,"FourSymbolsFeatures.isReady('dungeon')&&!document.getElementById('qaDungeonFeature').classList.contains('is-feature-loading')","dungeon feature ready",20000);
