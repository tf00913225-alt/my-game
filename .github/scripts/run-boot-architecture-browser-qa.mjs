...
try{
    ...
    await waitFor(client,"FourSymbolsFeatures.isReady('abyss')&&!document.getElementById('qaAbyssFeature').classList.contains('is-feature-loading')","abyss feature ready",20000);
