...
/* Monster identity belongs below its own thin HP/SP HUD; art must stay fully contained. */
assert.match(battle,/battle-monster\.v174-cardless-unit>\.battle-monster-name\{[\s\S]*top:calc\(100% \+ 3px\)!important;[\s\S]*z-index:24!important/);
assert.match(battle,/battle-monster\.v174-cardless-unit>\.v174-battle-art\{[\s\S]*inset:2px 2px 26px!important;[\s\S]*background-size:contain!important/);
