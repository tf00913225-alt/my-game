...
// Formal daily dungeons are intentionally 50% easier, so the final-spec integration
// factors are half the historical party/level-only values.
replaceRequired(
...
console.log("Applied scoped CI follow-up for canonical creation actions, Android-safe auth, 9:16 BOSS UI, temporary monster/BOSS portraits, and 50% daily-dungeon scaling.");
