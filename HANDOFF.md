...
- V173.70 release candidate: `release/v173.70-main-sync-20260921`, PR #417, candidate `a157199265a08fb94630d54e5581ff810bb9db5d`. Candidate CI, exact-SHA DEV preview/deployment and runtime regression evidence are complete; PR remains open and has not been merged to `main`. Because later dev-targeted PRs remain unmerged, #417 is not yet the final release entry point.
- Status/VFX integration: PR #418, branch `integration/status-vfx-front-back-monster-portraits-20260921`, head `9c93b9c0935a7d2db58152a6275cd9114c30119e`. CI and exact-SHA preview succeeded; it remains open and unmerged.
- Documentation: PR #419 updates `CHECK_REPORT.txt` and this current-status section; it remains open and unmerged.
- V138 wrapper convergence: PR #421, branch `refactor/render-battle-hook-v138-20260921`, exact head `31316b2ad64d7c6b39a66b0ca9b2b184850e7f74`. Repository checks run `35564806669` passed; Dev deployment gate was correctly skipped by diff scope. The PR remains open and has not been merged.
- Monster portrait batch PR #420 remains pending and is not part of this maintenance pass. No portrait image was changed in this pass.
- PR cleanup: obsolete V173.65 release PRs #278, #280, #282, #284, #286, #288, #290 and #292; older release PR #255; throwaway validation PR #257; and superseded VFX PR #410 were marked superseded and closed. Their branches were retained.
- Cloud Account: Phase 1 remains COMPLETE / 5/5 VERIFIED. Phase 2–10 remain NOT STARTED; no new cloud-save implementation was begun.
- Remaining release work: after the approved PRs enter `dev`, rebuild the final release candidate from the latest `main` plus latest `dev`, then rerun exact-SHA CI, DEV deployment and runtime/device acceptance. Historical entries below are preserved and may describe older baselines.
