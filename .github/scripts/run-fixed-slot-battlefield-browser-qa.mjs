...
function runViewport(chrome,width,height){
    ...
    assert.ok(data.turnUi.normal.rect.bottom<=baseline.command.top-.5,"turn timer must not overlap command art");
