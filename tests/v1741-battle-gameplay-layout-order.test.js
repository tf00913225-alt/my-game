...
assert.match(battle,/battle-monster\.v174-cardless-unit>\.v174-battle-art\{[\s\S]*?inset:15px -5px 26px!important;[\s\S]*?background-size:contain!important/);
assert.doesNotMatch(battle,/battle-monster\.v174-cardless-unit>\.v174-battle-art\{[^}]*?background-size:cover!important/s,"enemy combat art must not regress to cover cropping");
