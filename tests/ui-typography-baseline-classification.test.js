...
const exceptionRe=/(?:home-test-button|v17351-ad-|debug|dev-only|aria-hidden|REWARD PREVIEW|\.map-monster(?:\b|-)|display\s*:\s*none|visibility\s*:\s*hidden|screen-reader|sr-only|assistive)/i;
