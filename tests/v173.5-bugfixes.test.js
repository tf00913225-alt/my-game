...
test("new Water Orb sheet is the supplied 1536×1152 four-by-three asset",()=>{
    ...
    assert.match(animation,/water-orb-vfx\.png\?v=173\.14[\s\S]*?columns:4,rows:3,frames:12,frameWidth:384,frameHeight:384,hitFrame:7,[\s\S]*?renderer:"canvas-crop"/);
});
...
console.log("\nV173.14 bug-fix suite: "+passed+" tests passed.");
