...
test("the development release and cache advance to V173.24",()=>{
    ...
    assert.match(index,/css\/25-stage-v90-quest-interface-core\.css\?v=173\.24/);
});

console.log("\n"+passed+" V173.24 new-player and supplied-asset tests passed.");
