...
test("new Water Orb sheet is the approved transparent four-by-three asset",()=>{
    ...
    assert.match(animation,/water-orb-vfx\.png\?v=173\.8[\s\S]*?columns:4,rows:3,frames:12,hitFrame:7,placement:"targetTrajectory",travelToTargets:true/);
});
...
console.log("\nV173.8 bug-fix suite: "+passed+" tests passed.");
