...
const expected=[
    ["relic_qiankun_flask","relic_qiankun_flask.webp",1500,7,"allyAll"],
    ["relic_sun_orb","relic_sun_orb.webp",1300,7,"enemyAll"],
    ["relic_xuanwu_seal","relic_xuanwu_seal.webp",1550,8,"allyAll"],
    ["relic_soul_bell","relic_soul_bell.webp",1500,8,"enemyAll"],
    ["relic_tiangang_banner","relic_tiangang_banner.webp",1600,9,"enemyAll"],
    ["relic_nine_dragon_fire","relic_nine_dragon_fire.webp",1450,8,"enemyAll"],
    ["relic_cold_spring_jade","relic_cold_spring_jade.webp",1500,7,"singleAlly"],
    ["relic_qinglan_feather","relic_qinglan_feather.webp",1400,6,"allyAll"],
    ["relic_rock_mountain_seal","relic_rock_mountain_seal.webp",1550,7,"allyAll"],
    ["relic_returning_wheel","relic_returning_wheel.webp",1600,7,"singleAlly"],
    ["relic_origin_talisman","relic_origin_talisman.webp",1450,7,"allyAll"],
    ["relic_broken_army_scroll","relic_broken_army_scroll.webp",1300,8,"singleEnemy"],
    ["relic_red_sky_war_mark","relic_red_sky_war_mark.webp",1300,7,"allyAll"],
    ["relic_ice_mirror_heart","relic_ice_mirror_heart.webp",1450,6,"enemyAll"],
    ["relic_wind_chasing_talisman","relic_wind_chasing_talisman.webp",1250,6,"allyAll"],
    ["relic_mountain_river_cauldron","relic_mountain_river_cauldron.webp",1550,7,"allyAll"],
    ["relic_burning_star_mark","relic_burning_star_mark.webp",1300,7,"enemyAll"],
    ["relic_spirit_spring_bottle","relic_spirit_spring_bottle.webp",1450,6,"allyAll"],
    ["relic_demon_suppressing_seal","relic_demon_suppressing_seal.webp",1450,6,"allyAll"],
    ["relic_all_returning_array","relic_all_returning_array.webp",1600,8,"allyAll"]
];
...
assert.match(relic,/RELIC_VFX_FLOOR_MS=1200/,"relic VFX must keep a deliberate minimum cadence floor without stretching 12-frame sheets into slow motion");
...
assert.ok(expected.every(row=>row[2]>=1200&&row[2]<=1600),"reviewed 12-frame relic VFX durations must stay inside the premium 1.2-1.6 second cadence window");
