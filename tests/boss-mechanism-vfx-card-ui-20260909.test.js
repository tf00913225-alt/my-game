...
assert.match(boss,/\.boss-mechanism-card\{[\s\S]*?width:var\(--gameplay-mechanism-card-width\);[\s\S]*?aspect-ratio:9 \/ 16;[\s\S]*?flex:0 0 var\(--gameplay-mechanism-card-width\);/);
