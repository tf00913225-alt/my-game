...
test("the development release and cache advance to V173.25",()=>{
    ...
    assert.match(index,/css\/25-stage-v90-quest-interface-core\.css\?v=173\.25/);
});

console.log("\n"+passed+" V173.25 new-player and supplied-asset tests passed.");
