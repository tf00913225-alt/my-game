...
assert.ok(html.indexOf("js/52-v173.20-startup-loader.js?v=173.62")<html.indexOf("js/00-main.js?v=173.62"));
assert.match(html,/css\/51-v173\.20-startup-loader\.css\?v=173\.62/);
...
console.log("✓ V173.62 real startup progress + 12~15s cinematic gate");
