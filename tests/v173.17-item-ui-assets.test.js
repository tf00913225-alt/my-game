...
test("published development label advances to V173.38",()=>{
    assert.match(html,/<title>四象江湖傳 V173\.38<\/title>/);
    assert.match(html,/>V173\.38<\/div>/);
    assert.match(read("js/20-anonymous-20.js"),/const V_ASSET_VERSION="173\.38"/);
});

console.log("\n"+passed+" V173.38 item UI and asset tests passed.");
