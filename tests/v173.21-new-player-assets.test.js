...
test("the development release and cache advance to V173.21",()=>{
    ...
    assert.match(index,/css\/25-stage-v90-quest-interface-core\.css\?v=173\.21/);
});

console.log("\n"+passed+" V173.21 new-player and supplied-asset tests passed.");
