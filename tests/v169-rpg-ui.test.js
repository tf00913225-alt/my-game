...
test("V169 styles and runtimes are deployed last under fresh cache keys",()=>{
    assert.match(loaderSource,/const V_ASSET_VERSION="173\.40"/);
    assert.match(indexSource,/js\/00-main\.js\?v=173\.40/);
    assert.match(indexSource,/js\/19-stage-v78-character-inventory-runtime\.js\?v=173\.40/);
    assert.match(indexSource,/js\/20-anonymous-20\.js\?v=173\.40/);
