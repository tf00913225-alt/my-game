...
const observer=new MutationObserver(syncManagement);observer.observe(document.body,{subtree:true,childList:true,attributes:true,attributeFilter:["class","style"]});setInterval(syncManagement,300);syncManagement();
})();
