...
assert.match(css,/\.shop-potion-purchase-row\{[\s\S]*?grid-template-columns:38px minmax\(48px,1fr\) 54px !important;[\s\S]*?grid-template-rows:36px !important;[\s\S]*?height:36px !important;/);
