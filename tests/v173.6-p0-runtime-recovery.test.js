...
assert.match(animation,/water-orb-vfx\.png\?v=173\.14/);
assert.match(loader,/const V_ASSET_VERSION="173\.14"/);
assert.match(index,/<title>四象江湖傳 V173\.14<\/title>/);

console.log("V173.14 P0 known-good animation-chain recovery: 10 tests passed.");
