...
test("published development label advances to V173.20",()=>{
    assert.match(html,/<title>四象江湖傳 V173\.20<\/title>/);
    assert.match(html,/>V173\.20<\/div>/);
    assert.match(read("js/20-anonymous-20.js"),/const V_ASSET_VERSION="173\.20"/);
});

console.log("\n"+passed+" V173.20 item UI and asset tests passed.");
