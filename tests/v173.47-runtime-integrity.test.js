...
assert.ok(loader.indexOf("installV17347RuntimeReadinessGate")<loader.indexOf('const V_ASSET_VERSION="173.52"'),"readiness gate must install before late loaders can expose legacy UI");
