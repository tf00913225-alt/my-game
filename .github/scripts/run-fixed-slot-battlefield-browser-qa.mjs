...
(function(){
 ...
 actionRegion.classList.add('target-selecting');turnUi.targetSelecting={opacity:getComputedStyle(turnNode).opacity,pointerEvents:getComputedStyle(turnNode).pointerEvents,rect:rect('#turnTargetRow')};actionRegion.classList.remove('target-selecting');
...
function runViewport(chrome,width,height){
    ...
    assert.ok(data.turnUi.targetSelecting.rect.bottom<data.turnUi.normal.rect.top,"target-selecting turn timer moves above the target prompt/command area");
