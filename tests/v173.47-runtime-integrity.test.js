...
assert.ok(loader.indexOf("installV17347RuntimeReadinessGate")<loader.indexOf('const V_ASSET_VERSION="173.51"'),"readiness gate must install before late loaders can expose legacy UI");
...
assert.match(ui,/equipment-progression\.js\?v=173\.51/);
