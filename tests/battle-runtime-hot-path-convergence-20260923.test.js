...

{
    ...
    assert.match(fixedCss,/--battle-command-row-height:66px/);
    assert.match(fixedCss,/--battle-command-art-overhang:34px/);
    assert.match(fixedCss,/--battle-command-visual-height:calc\(var\(--battle-command-row-height\) \+ var\(--battle-command-art-overhang\)\)/);
