...
assert.match(equipment,/53-v173\.50-inventory-qol\.js\?v=173\.56/);
assert.match(equipment,/__v173ReportRuntimeProgress\("v17350-inventory-qol-runtime"/);
assert.match(qol,/54-v173\.51-battle-qa\.js\?v=173\.56/);
assert.match(qol,/57-v173\.51-quest-qa\.js\?v=173\.56/);
assert.match(qol,/__v173ReportRuntimeProgress\(pair\[0\],pair\[1\]\)/);
assert.match(index,/<title>四象江湖傳 V173\.56<\/title>/);
console.log("✓ V173.56 real startup progress integration");
