...

{
    ...
    assert.notDeepEqual(slotCenter&&{x:slotCenter.x,y:slotCenter.y},artCenter,"Boss artwork center must differ from Fixed Slot center in this regression fixture");
