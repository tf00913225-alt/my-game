...
assert.match(relicCss,/team-relic-home-entry \.home-card-icon\{background-image:url\("\.\.\/assets\/ui\/home-relic-v174\.webp"\);\}/);
assert.match(relicCss,/team-relic-home-entry \.team-relic-home-glyph\{font-size:0;color:transparent/);
