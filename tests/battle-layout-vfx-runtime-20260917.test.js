...
assert.match(vfx,/applySpriteBox\(node,width,height,sprite,"stretch"\)/,"range VFX must fill its complete Fixed Slot bounds without entering the operation track");
